...
SECTION_SCHEMAS: dict[int, list[SchemaField]] = {
    ...
    9: [
        ...
        SchemaField("pH值", aliases=("PH值", "pH", "PH value", "pH-value", "pH-value at 20 °C",
                                "pH-value at 25 °C", "pH (10% in water)")),
        ...
        SchemaField("蒸发速率", aliases=("蒸发速度", "百分比挥发性", "Evaporation rate", "Percent volatility",
                                "Volatility")),
        ...
        SchemaField("水溶性", aliases=("水中溶解度", "溶解度", "溶解性", "Water solubility",
