...
with sync_playwright() as p:
    ...
    page.goto("https://www.mee.gov.cn/searchnew/?searchword=18484-2020", timeout=30000)
    page.wait_for_timeout(3000)
    
    links = page.evaluate('''() => Array.from(document.querySelectorAll('a')).map(a => [(a.innerText || '').trim(), a.href]).filter(x => x[0].includes('18484') || x[0].includes('危险废物焚烧'));''')
    print("Search 18484 links:", links)
